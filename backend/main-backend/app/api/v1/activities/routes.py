...
from app.core.storage import Activity, User, activity_store
...
def create_activity(
    ...
    if supabase_client.is_configured():
        ...
        raise HTTPException(status_code=500, detail="Failed to create activity") from None
...
def update_activity(
    ...
    activity_store.update(
        activity_id, name=update.name, description=update.description, is_public=update.is_public
    )
