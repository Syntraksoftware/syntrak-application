...
# Root backend directory and monorepo root (shared venv lives at repo root)
backend_directory = Path(__file__).parent.resolve()
...
# Shared venv at repository root (not under backend/)
...
def main():
    ...
    if not VENV_PYTHON.exists():
        print("\n❌ ERROR: Repository root venv not found!")
